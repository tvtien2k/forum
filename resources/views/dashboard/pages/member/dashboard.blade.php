...
@section('js')
    ...
    <script src="assets_dashboard/js/raphael.min.js"></script>
    <script src="assets_dashboard/js/morris.min.js"></script>
    <script src="assets_dashboard/js/morris-data.js"></script>
